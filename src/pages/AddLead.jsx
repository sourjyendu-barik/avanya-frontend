...
const AddLead = () => {
  ...
  const [leadFormData, setLeadFormData] = useState({
    name: "",
    source: "",
    salesAgent: "", // ObjectId stored as string in forms
    status: "",
            ...
            <div className="mb-3 row align-items-center">
              ...
              <div className="col-sm-10">
                <Select
                  ...
                  value={
                    leadSourceList.find(
                      (l) => l.value === leadFormData.source
                    ) || null
                  }
                  onChange={(selected) =>
                    handleChange("source", selected?.value)
                  }
                />
              </div>
            </div>
            ...
            <div className="mb-3 row align-items-center">
              ...
              <div className="col-sm-10">
                <Select
                  ...
                  value={
                    priorityList.find(
                      (o) => o.value === leadFormData.priority
                    ) || null
                  }
                  onChange={(selectd) =>
                    handleChange("priority", selectd?.value)
                  }
                />
              </div>
            </div>
